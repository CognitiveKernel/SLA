...
class LLMEngine:
    ...
    def _init_workers_ray(self, placement_group: "PlacementGroup",
        ...
        # print('number of workers after the initialization ray', len(self.workers))
    ...
    def _process_sequence_group_outputs(self, seq_group: SequenceGroup,
        ...
        print('start to process the output:')
        print('*'*32)
    ...
    def _determine_ck_status(self, seq: Sequence,
                             sampling_params: SamplingParams) -> int:
        ck_status_ids = seq.get_token_ck_status_ids()
        continue_count = 0
        for tmp_ck_status_id in ck_status_ids:
    ...
    def _check_stop(self, seq: Sequence,
        ...
        # if sampling_params.ck_mode == "RewardScoreCheck":
