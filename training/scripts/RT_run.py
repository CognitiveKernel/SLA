...
from RT_trainer import RTTrainer
...
def main():
    parser = H4ArgumentParser((ModelArguments, DataArguments, RTConfig))
    ...
    if "test" not in raw_datasets:
        raw_datasets_splited = raw_datasets["train"].train_test_split(train_size=0.99, seed=42)
        raw_datasets["test"] = raw_datasets_splited["test"]
