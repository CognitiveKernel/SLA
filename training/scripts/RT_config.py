...
@dataclass
class RTConfig(TrainingArguments):
    r"""
    ...
    ck_loss_weight: float = 1.0
    ck_loss_type: str = "seqwise_btmodel"
    ck_loss_a: float = 1.0 
    ck_loss_b: float = 0.0 
    ck_xpoloss_weight: float = 0.0 

    sr_freeze_base_model: bool = False
    sr_out_dim: int = 2
    sr_head_layer: int = 1
    sr_hidden_size_rate: int = 1
    tt_hidden_size: int = 256